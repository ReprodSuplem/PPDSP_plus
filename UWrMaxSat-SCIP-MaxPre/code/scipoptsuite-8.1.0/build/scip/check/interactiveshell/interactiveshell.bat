...
read /home/zha/exp/PPDSP_plus/UWrMaxSat-SCIP-MaxPre/code/scipoptsuite-8.1.0/scip/check/instances/MIP/vpm2.fix
read /home/zha/exp/PPDSP_plus/UWrMaxSat-SCIP-MaxPre/code/scipoptsuite-8.1.0/scip/check/instances/MIP/vpm2.sol
optimize
checksol
disp mem
disp problem
